...
const FormAddBus = props => {
  document.title = "Form Add Bus | Bus Buddy"
  ...
  useEffect(() => {
    props.setBreadcrumbItems("Add Bus", breadcrumbItems)
  })
  ...
  const partnershipDocId = localStorage.getItem("partnershipDocId")
  ...
  const handleAddNewBus = async values => {
    try {
      ...
      const partnershipRef = doc(db, "partnership", partnershipDocId)
      ...
      const payloads = {
        ...
        aisleColumn: Number(aisleColumn),
        remainingSeats: Number(facilities[0].name),
    ...
    <React.Fragment>
      <Row>
        <Col className="col-12">
          <Card>
            <CardBody>
              <CardTitle className="h4 mb-4">Form Add Bus</CardTitle>
...
export default connect(null, { setBreadcrumbItems })(FormAddBus)
